...
<!-- ╚══════════════════════════════════════════════════════════════╝ -->
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0d1117,30:0a1628,70:00599C,100:0d1117&height=220&section=header&text=Тимур%20Билалов&fontSize=56&fontColor=ffffff&fontAlignY=40&desc=C%2B%2B%20Systems%20Engineer%20%E2%80%93%20ITMO%20University&descAlignY=62&descSize=17&descColor=7aa2cc" width="100%"/>
...
Командный проект, летняя практика совместно с Авито. Сравнение алгоритмов балансировки нагрузки на асинхронных корутинах. Настраиваемые сценарии, JSON-отчёты с детальной статистикой по латентности, отказам и распределению. Веб-интерфейс для визуализации.
...
Собственная Swiss Table с SIMD-ускорением поиска, геоиндекс на кодах Мортона, пользовательский аллокатор для точного учёта памяти.
...
Библиотека для построения вычислительных DAG. Policy-Based Design: кеширование, обработка ошибок и планировщик подключаются независимо. Дуга является вычислительным узлом и строит граф рекурсивно без дублирования топологии.
...
ELF в RISC-V asm. Разбор машинного кода в читаемый ассемблер без сторонних библиотек, ISA изнутри.

<br/>

**Параметризуемый float** - `C++`
...
Параметризуемый формат с плавающей точкой на C++ на целых числах: e4m3fn / e5m2 / half / double
...
| **STL-совместимый кольцевой буфер** | `C++23` | AllocatorAwareContainer с нуля: placement new, exception safety, RandomAccessIterator |
| **Архиватор Хэмминга** | `C++` | Подключаемые схемы кодирования, коррекция битовых ошибок |
| **Сервис маршрутов** | `C++20` `REST` `FTXUI` | Яндекс.Расписания: внешний API + кэш запросов + TUI |
